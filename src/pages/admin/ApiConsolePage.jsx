...
const endpoints = [
  ...
  { method: "POST", path: "/api/auth/account-activation/resend", description: "Request a new activation email" },
  { method: "GET", path: "/api/auth/account-activation/validate", description: "Validate an account activation token" },
  { method: "POST", path: "/api/auth/account-activation", description: "Activate an account with a token" },
  { method: "POST", path: "/api/auth/forgot-password", description: "Request a password reset email" },
  { method: "GET", path: "/api/auth/reset-password/validate", description: "Validate a password reset token" },
  { method: "POST", path: "/api/auth/reset-password", description: "Set a new password with a reset token" },
  ...
  { method: "PATCH", path: "/api/notifications/read-all", description: "Mark all notifications as read" },
  { method: "PATCH", path: "/api/notifications/{id}/dismiss", description: "Dismiss notification" },
]
